...
image:https://codecov.io/github/KostyaSha/github-integration-plugin/coverage.svg?branch=master["codecov.io", link="http://codecov.io/github/christiangalsterer/httpbeat?branch=master"]
